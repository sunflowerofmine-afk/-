...
def run(preview: bool = False):
    ...
    for _obs_c in obs_candidates:
        ...
        key_candidates.append({
            ...
            "freshness_count":               freshness_map.get(_obs_code, 0),
            "nxt_dominant":                  _obs_code in nxt_top_codes,
            "prev_high":                     _obs_enr_d.get("prev_high"),
            "prev_close":                    _obs_enr_d.get("prev_close"),
            "today_open_price":              _obs_enr_d.get("today_open_price"),
            "inst_oversupply_pct":           _obs_enr_d.get("inst_oversupply_pct"),
            "frgn_oversupply_pct":           _obs_enr_d.get("frgn_oversupply_pct"),
            "sector":                        _obs_sector,
